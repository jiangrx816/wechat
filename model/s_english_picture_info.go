...
type SEnglishPictureInfo struct {
	...
	BookId   string `gorm:"column:book_id;type:varchar(255);comment:绘本id;NOT NULL" json:"book_id"`
	Pic      string `gorm:"column:pic;type:varchar(1024);comment:详情图;NOT NULL" json:"pic"`
	BPic     string `gorm:"column:b_pic;type:varchar(1024);comment:详情图;NOT NULL" json:"b_pic"`
	Mp3      string `gorm:"column:mp3;type:varchar(1024);comment:Mp3;NOT NULL" json:"mp3"`
	En       string `gorm:"column:en;type:varchar(1024);comment:英文内容;NOT NULL" json:"en"`
	Zh       string `gorm:"column:zh;type:varchar(1024);comment:中文内容;NOT NULL" json:"zh"`
